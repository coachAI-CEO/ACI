  ...
  return (
    <div className="w-full flex flex-col items-center gap-2">
      ...
      >
        ...
        {/* Lane fills (wide, half-space, central) */}
        ...
        {/* Halfway line for HALF pitch (top→bottom) */}
        <line
          x1={2}
          y1={50}
          x2={98}
        ...
        {/* Penalty box + goal at top (defending goal) */}
        <rect
          x={30}
          y={5}
          width={40}
        ...
        {/* Center circle arc (only bottom half since it's a HALF pitch) */}
        <path
          d={`
            M 50 50
            m -9 0
