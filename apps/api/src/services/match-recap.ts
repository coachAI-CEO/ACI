...
export function showcaseRecap(input?: { opponent?: string }): MatchRecap {
  return {
    ...
    pillars: [
      { title: "Defensive Discipline", body: "We limited their looks and stayed compact when the game stretched." },
      { title: "Possession to Our Standard", body: "When we had the ball, we played at our tempo — not theirs." },
      { title: "Team Togetherness", body: "Players competed for each other. That is the standard." },
      { title: "Growth Mindset", body: "First official match. The journey starts here, not with the scoreboard." },
    ],
    stats: {
      shots: { us: 6, them: 9 },
