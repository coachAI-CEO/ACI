 ...
 *
 * Shared between `apps/web` (TacticalBoardEditor + ScaledPitchMarkings) and
 * `apps/mobile` (the native editor planned in
 * `docs/TACTICAL_BOARD_MOBILE_PLAN.md`). Pure data + pure functions; no DOM.
 */
