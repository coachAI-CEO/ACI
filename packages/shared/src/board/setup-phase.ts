/**
 * Setup phase / zone / channel — UI labels + helpers shared by web + mobile.
 * Placement geometry lives in the API chassis (`applySetupPhaseToDiagram`);
 * clients call that locally (web) or via `POST /boards/:id/phase-place` (mobile).
 */
