...
- **Board editor parity: landscape, formations, setup phases, label editing** — **Completed:** v1.12.0 (2026-08-27)
- **Board AI image upload (F v2)** — mobile now mirrors the web editor (`expo-image-picker` → `/boards/:id/ai-chat` `image`) — **Completed:** v1.12.0 (2026-08-27)
- **`codex/mobile-app` synced to `main`** (game-model merge) — **Completed:** v1.12.0 (2026-08-27)
